...
import style from "../../Pages/rent/RentHouseDetail.module.css";
...
const RentHouseDetail = () => {
  ...
  const handleClick = () => {
    mutate(`${process.env.REACT_APP_API_URL}/rent/${id}`, {
        method: 'POST',
        data: {
          user_id: user.id,
          house_id: id,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await mutate(`${process.env.REACT_APP_API_URL}/rent/${id}/message`, {
        method: 'POST',
        data: {
          user_id: user.id,
          house_id: id,
